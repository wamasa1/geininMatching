...
@section('header')
  ...
  <h1 id="title-font" class="text-dark display-3 pt-2 mt-2 mb-3">登録情報変更</h1>
@endsection

@section('body')
  <!-- パスワード変更完了メッセージ -->
  @include('shared.flash_message', ['message' => 'password_success'])
  <!-- テストユーザー -->
  @include('shared.flash_message', ['message' => 'test_user'])
